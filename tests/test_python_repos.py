# Exercise 17-3: Testing Python Repos > tests testing_python_repos.py
import pytest

from testing_python_repos import get_repos_info, get_response_dict, get_repo_dicts
...
def test_response_dict(response):
    """Verify an appropriate number of repositories are represented, and verify the results are complete."""
